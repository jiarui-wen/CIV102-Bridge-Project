...
ystrutgbot = hside - hglue - hstrutg - hstrut - hstrutg./2
...
ysplice = hside - hglue - 2.*hstrutg - hstrut - hsplice./2
Isplice = bsplice .* (hsplice.^3) ./12

Aspliceg = bspliceg .* hspliceg
yspliceg = hside-hglue-2.*hstrutg-hstrut-hsplice-hspliceg./2
...
T_max = 4;
T_gmax = 2;
S_buck1 = 4*pi^2*E/(12*(1-mu^2)) * (1.27*2/40).^2
