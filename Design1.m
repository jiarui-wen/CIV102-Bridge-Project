...
param_bot = [0, 80-1.27*2, 1.27];
% param_diaph = [0, 50, 250, 950, 1150, 1200] FOS_buckV = 2.7164
% param_diaph = [0, 25, 250, 950, 1175, 25]   FOS_buckV = 2.2979
% param_diaph = [0, 75, 250, 950, 1125, 1200]  2.7164
% param_diaph = [0, 40, 250, 950, 1160, 1200]  2.7164
% param_diaph = [0, 30, 250, 950, 1170, 1200]  2.5398
% param_diaph = [0, 35, 250, 950, 1165, 1200]  2.5909
% param_diaph = [0, 50, 300, 900, 1150, 1200]  2.4432
% param_diaph = [0, 50, 200, 1000, 1150, 1200] 2.4507

param_diaph = [0, 50, 250, 600, 950, 1150, 1200]  % 2.7577
% param_diaph = [0, 50, 250, 450, 750, 950, 1150, 1200]
